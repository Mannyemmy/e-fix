...
class FrontendSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $jsonDataSection5 = '{"section_5":1,"title":"Elevate Your Sales and Expertise by Joining Us","email":"info@efix.ng","contact_number":"07043658330","description":"Dedicated Provider, Delivering Exceptional Service. Proven Expertise for Quality Results and Client Satisfaction.  Elevate Your Project Together."}';
