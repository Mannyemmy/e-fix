...
<div class="policy-hero">
    ...
    <h1>Refund Policy</h1>
    <p>Our commitment to fair and transparent refund &amp; cancellation terms.</p>
</div>
    ...
    <div class="policy-layout">
        ...
        <aside class="policy-sidebar">
            <div class="sidebar-card">
                ...
                <a class="nav-link" href="{{ route('user.term_conditions') }}">
                    <i class="fas fa-file-contract"></i> Terms & Conditions
                </a>
                <a class="nav-link active" href="{{ route('user.refund_policy') }}">
        ...
        <div>
            <div class="policy-main-card">
                <div class="policy-meta">
                    <span><i class="fas fa-exchange-alt"></i> Refund Policy</span>
                    <span>·</span>
                    <span><i class="far fa-calendar"></i> Last updated: {{ date('F j, Y') }}</span>
                </div>
                <div class="policy-divider"></div>

                @if(!empty($refund_policy->value))
                ...
                @else
                    <div class="policy-empty-state">
                        ...
                        <p>Our Refund Policy is being updated. Please check back shortly.</p>
