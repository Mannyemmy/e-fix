    ...
    <div class="policy-layout">
        ...
        <aside class="policy-sidebar">
            <div class="sidebar-card">
                ...
                <a class="nav-link active" href="{{ route('user.privacy_policy') }}">
            ...
            <div class="policy-main-card">
                ...
                @else
                    <div class="policy-empty-state">
                        ...
                        <p>Our Privacy Policy is being updated. Please check back shortly.</p>
                        <p>For questions, contact us at <a href="mailto:{{ config('app.inquiry_email', 'support@elitefixconnect.com') }}">support@elitefixconnect.com</a>.</p>
                    </div>
                @endif
            </div>
        </div>
