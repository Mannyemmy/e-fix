<?php return array(
        ...
        'whatsapp_number_placeholder' => 'e.g. +2348012345678',
        'whatsapp_number_hint' => 'Include country code (e.g. +234). Visitors will be able to chat via WhatsApp.',
        ...
        'price_offer_sent_message' => ':name sent you a price offer of :price',
        'price_offer_sent_title' => 'New price offer',
        'price_offer_countered_message' => ':name sent you a counter offer of :price',
        'price_offer_countered_title' => 'New counter offer',
        'price_offer_accepted_message' => 'Your price offer was accepted by :name',
        'price_offer_accepted_by_provider_message' => ':name accepted your counter offer',
        'price_offer_accepted_title' => 'Price offer accepted',
        'price_offer_declined_message' => 'Your price offer was declined by :name',
        'price_offer_declined_by_provider_message' => ':name declined your counter offer',
        'price_offer_declined_title' => 'Price offer declined',
        'collect_cash' => 'Collect Cash From Provider',
        'bank_name' => 'Bank Name',
        'branch_name' => 'Branch Name',
        'ifsc_no' => 'IFSC Code',
        ...
        'referral' => 'Referral',
        'enable_referral_system' => 'Enable Referral System',
        'referral_percentage' => 'Referral Commission Percentage (%)',
        'referral_percentage_help' => 'Percentage of admin commission earned by referrer on each completed booking by the referred user',
        'referral_reward' => 'Referral Reward',
        'referral_reward_earned' => 'You have earned a referral reward of :amount!',
        'all_referrals' => 'All Referrals',
        'referral_setting' => 'Referral Settings',
        'referrer' => 'Referrer',
        ...
        'user_signs_up' => 'User Signs Up',
        'flow_signup_desc' => 'New user enters an optional referral code during registration. Recorded as pending.',
        'earns_referral_code' => 'Earns Referral Code',
        'flow_code_desc' => 'User gets an auto-generated code on the Refer & Earn page with share button, stats & history.',
        'booking_completed' => 'Booking Completed',
        'flow_booking_desc' => 'When the referred user\'s first booking is completed, the referrer\'s wallet is credited.',
        'flow_booking_desc_new' => 'Every time the referred user completes a booking, you earn a percentage of the admin commission — recurring!',
        'view_history' => 'View History',
        'flow_history_desc' => 'Referrer can track all referrals, rewards earned, and pending payouts in the app.',
        'status_pending' => 'Pending',
        'auto_generated' => 'Auto-Generated',
        'wallet_credited' => 'Wallet Credited',
        'uses_your_code' => 'Uses Your Code',
        'people_referred' => 'People Referred',
        'recurring' => 'Recurring',
        'recurring_earning' => 'Recurring Earnings',
        'referral_app' => 'Refer & Earn Page',
        ...
        'withdraw_request_debit' => 'Withdrawal request submitted for :amount. Your wallet has been debited.',
        'withdraw_request_approved' => 'Your withdrawal request for :amount has been approved.',
        'withdraw_request_rejected' => 'Your withdrawal request for :amount was rejected and the amount has been refunded to your wallet.',
        'withdraw_request' => 'Withdraw Request',
        'withdraw_request_list' => 'Withdraw Requests',
        'insufficient_wallet_balance' => 'Insufficient wallet balance for this withdrawal request.',
        'withdraw_request_already_processed' => 'This withdrawal request has already been processed.',
        'withdraw_request_approved_msg' => 'Withdrawal request approved successfully.',
        'withdraw_request_rejected_msg' => 'Withdrawal request rejected and amount refunded to wallet.',
        'reconcile_paystack_payment' => 'Reconcile Paystack Payment',
        'reconcile_paystack_payment_help' => "Enter a booking's ID and the Paystack reference for a charge that succeeded on Paystack but was never recorded here (e.g. a dropped webhook).",
        'paystack_reference' => 'Paystack Reference',
        'verify_with_paystack' => 'Verify with Paystack',
        'booking_not_found' => 'Booking not found.',
        'paystack_not_verified' => 'Paystack did not confirm this reference as a successful charge.',
        'payment_already_reconciled' => 'This reference has already been reconciled — nothing more to do.',
        'payment_reconciled_msg' => 'Payment #:id created. Booking, provider wallet, and notifications have been updated.',
        'paystack_email_mismatch_warning' => "Warning: the Paystack payer's email does not match this booking's customer email. Double-check this is the right booking before confirming.",
        'confirm_mark_paid' => 'Confirm & Mark Paid',
