...
class SettingController extends Controller
{
    ...
    public function layoutPage(Request $request)
    {
        ...
        switch ($page) {
            ...
            case 'userdashboard-setting':
                $userdashboardsetting   = Setting::where('type', '=', 'userdashboard-setting')->first();
    ...
    public function saveUserDashboardTypeSetting(Request $request)
    {
        if (demoUserPermission()) {
            return  redirect()->back()->withErrors(trans('messages.demo_permission_denied'));
        }
        ...
        switch ($request->dashboard_type) {
            case 'dashboard_1':
                $data['value'] = 'dashboard_1';
                break;
            case 'dashboard_2':
                $data['value'] = 'dashboard_2';
                break;
            case 'dashboard_3':
                $data['value'] = 'dashboard_3';
                break;
            case 'dashboard_4':
                $data['value'] = 'dashboard_4';
                break;
            default:
        ...
        $data = [
            'type'  => 'userdashboard-setting',
            'key'   => 'userdashboard-setting',
            'value' => $data['value'],
        ];
